# usr/bin/python
# This accepts a list of textures to go through and perform a batch operation
# on it's Crytiff IPTC RC instructions then spits out a bat file to run the operation
import tifffile
import re
...
def main():
    batch = [
        "D:/Perforce/GameSDK/Objects/natural/trees/white_fir/white_fir_leaves_diff.tif",
    ...
    for image in batch:
        ...
        batch_list.append(
            executable + ' -SpecialInstructions="%s" "%s"' % (fixed_iptc, image)
        )
